...
//    every --tw-* declaration (Tailwind utility internals), with
//    `/* @kind other */`. Walks declarations with a rule stack so nested
...
function tagBundleCss(css) {
  ...
  for (let i = 0; i < css.length; i++) {
    ...
    if (ch === '(') depth++;
      ...
      const unlabelled = name.startsWith('--tw-') || (inTheme && tokenKind(name, value.trim()) === null);
